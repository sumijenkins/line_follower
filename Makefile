##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [4.7.0-B52] date: [Fri Sep 05 14:19:06 TRT 2025]
##########################################################################################################################
...
# *** EOF ***
# Tüm .o dosyalarını topla
OBJECTS := $(wildcard build/*.o)

# object.list dosyası oluştur
object.list:
	@echo $(OBJECTS) > object.list
